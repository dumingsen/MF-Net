...
#python draw_picture/plot_TSNE.py model_path='../saved_model/AtrialFibrillation/AtrialFibrillation batch=16 length=3072 window=64.pkl'
##python draw_picture/plot_TSNE.py
...
parser.add_argument('--model_path', type=str,
                    default='./saved_model/PEMS-SF/PEMS-SF batch=2 length=3072 window=64.pkl')
#G:\桌面\MF-Net-1128 - 副本\saved_model
#../saved_model/
...
print('filename',file_name)#AtrialFibrillation
...
with torch.no_grad():
    ...
    for x, y in test_loader:
        ...
        embedding,  output, pred_y = net(x)#encoder,
        #embedding,pred_y = net(x)
